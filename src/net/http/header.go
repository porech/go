...
// associated with key, matched with the exact case.
...
// It returns the first header value that matches the key case-insensitively.
...
// It returns all the header values that match the key case-insensitively.
